...
<br> -->
<? include '../../header.php'; ?>
<div class="col-6 offset-3 bg-rid">
<table class="table table-sm table-bordered bg-rid">
	<tr>
		<td>
			<table class="table table-sm table-bordered bg-rid" style="    background: border-box;">
				<TR>
...
<TABLE align=center>
	<tr>
		<td><A class="btn btn-success mb-5" href="../../index.php">Home Page</A></td>
	</tr>
</table>
</TABLE>
</div>
